...
public class SupplierPickList {
     ...
     * 企业ID
     */
    public SupplierPickList supplierid(String supplierid){
     ...
     * 字典字段名称
     */
    public SupplierPickList picklistname(String name){
        this.name = name;
        return this;
    }
     ...
     * 字典字段标签
     */
    public SupplierPickList picklistlabel(String label){
        this.label = label;
        return this;
    }

    public SupplierPickList picklistentitys(List<PickListEntity> entitys){
        this.entitys = entitys;
        return this;
    }

    public SupplierPickList builtin(Boolean builtin) {
        this.builtin = builtin;
        return this;
    }

    public SupplierPickList() { }
    public SupplierPickList(Object picklist) {
        if(picklist instanceof HashMap){
            ...
            this.supplierid = ((HashMap) picklist).getOrDefault("supplierid","").toString();
    ...
    public String toString(String indent) {
        ...
        sb.append(indent).append("new SupplierPickList()");
