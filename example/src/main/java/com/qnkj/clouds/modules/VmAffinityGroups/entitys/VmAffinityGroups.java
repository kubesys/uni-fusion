package com.qnkj.clouds.modules.VmAffinityGroups.entitys;
...
@Getter
@Setter
public class VmAffinityGroups extends BaseRecordConfig {
	...
	public VmAffinityGroups() {
		this.id = "";
	}

	public VmAffinityGroups(Object dataObj) {
		this.id = "";
