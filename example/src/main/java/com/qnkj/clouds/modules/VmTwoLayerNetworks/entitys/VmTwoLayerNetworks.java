package com.qnkj.clouds.modules.VmTwoLayerNetworks.entitys;
...
@Getter
@Setter
public class VmTwoLayerNetworks extends BaseRecordConfig {

	public VmTwoLayerNetworks() {
		this.id = "";
	}

	public VmTwoLayerNetworks(Object dataObj) {
		this.id = "";
