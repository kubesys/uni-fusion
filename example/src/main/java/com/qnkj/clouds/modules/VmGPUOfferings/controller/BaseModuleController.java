...
import com.qnkj.clouds.modules.VmGPUOfferings.entitys.VmGPUOfferings;
...
@Slf4j
@Validated
@Controller("base-VmGPUOfferings")
...
public class BaseModuleController {
    ...
    public Object ajaxIndex(HttpServletRequest request) {
        Map<String,Object> list = vmgpuofferingsService.getListViewEntity(request,viewEntitys, VmGPUOfferings.class);
    ...
    public Object editView(HttpServletRequest request,HttpServletResponse response, Model model) {
        ...
        VmGPUOfferings result = (VmGPUOfferings) vmgpuofferingsService.getObjectByRecord(httpRequest.get("record"),viewEntitys,VmGPUOfferings.class);
        if(result != null) {
    ...
    public Object editViewSave(HttpServletRequest request, Model model) {
        try{
            ...
            vmgpuofferingsService.save(httpRequest,viewEntitys,VmGPUOfferings.class);
    ...
    public Object delete(HttpServletRequest request, Model model) {
        try {
            Map<String, Object> httpRequest = Utils.getRequestQuery(request);
            vmgpuofferingsService.delete(httpRequest,viewEntitys);
    ...
    public Object active(HttpServletRequest request, Model model) {
        try{
            Map<String, Object> httpRequest = Utils.getRequestQuery(request);
            vmgpuofferingsService.active(httpRequest,viewEntitys);
    ...
    public Object inactive(HttpServletRequest request, Model model) {
        try{
            Map<String, Object> httpRequest = Utils.getRequestQuery(request);
            vmgpuofferingsService.inactive(httpRequest,viewEntitys);
    ...
    public Object popupView(HttpServletRequest request, Model model) {
        model.addAttribute("ENTITYURL", "VmGPUOfferings/popupentity/ajax");
    ...
    public Object popupEntity(HttpServletRequest request, Model model) {
        Map<String,Object> list = vmgpuofferingsService.getListViewEntity(request,viewEntitys, VmZones.class);
