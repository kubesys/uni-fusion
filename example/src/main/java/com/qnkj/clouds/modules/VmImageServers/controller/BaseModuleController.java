...
@Slf4j
@Validated
@Controller("base-VmImageServers")
...
public class BaseModuleController {
    ...
    public Object ajaxIndex(HttpServletRequest request) {
        Map<String,Object> list = vmimageserversService.getListViewEntity(request,viewEntitys, VmImageServers.class);
    ...
    public Object editView(HttpServletRequest request,HttpServletResponse response, Model model) {
        ...
        VmImageServers result = (VmImageServers) vmimageserversService.getObjectByRecord(httpRequest.get("record"),viewEntitys,VmImageServers.class);
        if(result != null) {
    ...
    public Object editViewSave(HttpServletRequest request, Model model) {
        try{
            ...
            vmimageserversService.save(httpRequest,viewEntitys,VmImageServers.class);
    ...
    public Object active(HttpServletRequest request, Model model) {
        try{
            Map<String, Object> httpRequest = Utils.getRequestQuery(request);
            vmimageserversService.active(httpRequest,viewEntitys);
    ...
    public Object inactive(HttpServletRequest request, Model model) {
        try{
            Map<String, Object> httpRequest = Utils.getRequestQuery(request);
            vmimageserversService.inactive(httpRequest,viewEntitys);
    ...
    public Object delete(HttpServletRequest request, Model model) {
        try {
            Map<String, Object> httpRequest = Utils.getRequestQuery(request);
            vmimageserversService.delete(httpRequest,viewEntitys);
    ...
    public Object popupView(HttpServletRequest request, Model model) {
        model.addAttribute("ENTITYURL", "VmImageServers/popupentity/ajax");
