...
import com.qnkj.clouds.modules.VmSecurityGroups.entitys.VmSecurityGroups;
...
@Slf4j
@Validated
@Controller("base-VmSecurityGroups")
...
public class BaseModuleController {
    ...
    public Object ajaxIndex(HttpServletRequest request) {
        Map<String,Object> list = vmsecuritygroupsService.getListViewEntity(request,viewEntitys, VmSecurityGroups.class);
    ...
    public Object editView(HttpServletRequest request,HttpServletResponse response, Model model) {
        ...
        VmSecurityGroups result = (VmSecurityGroups) vmsecuritygroupsService.getObjectByRecord(httpRequest.get("record"),viewEntitys,VmSecurityGroups.class);
        if(result != null) {
    ...
    public Object editViewSave(HttpServletRequest request, Model model) {
        try{
            ...
            vmsecuritygroupsService.save(httpRequest,viewEntitys,VmSecurityGroups.class);
    ...
    public Object delete(HttpServletRequest request, Model model) {
        try {
            Map<String, Object> httpRequest = Utils.getRequestQuery(request);
            vmsecuritygroupsService.delete(httpRequest,viewEntitys);
    ...
    public Object active(HttpServletRequest request, Model model) {
        try{
            Map<String, Object> httpRequest = Utils.getRequestQuery(request);
            vmsecuritygroupsService.active(httpRequest,viewEntitys);
    ...
    public Object inactive(HttpServletRequest request, Model model) {
        try{
            Map<String, Object> httpRequest = Utils.getRequestQuery(request);
            vmsecuritygroupsService.inactive(httpRequest,viewEntitys);
    ...
    public Object popupView(HttpServletRequest request, Model model) {
        model.addAttribute("ENTITYURL", "VmSecurityGroups/popupentity/ajax");
    ...
    public Object popupEntity(HttpServletRequest request, Model model) {
        Map<String,Object> list = vmsecuritygroupsService.getListViewEntity(request,viewEntitys, VmZones.class);
