...
import com.qnkj.clouds.modules.VmIPsecTunnels.entitys.VmIPsecTunnels;
...
@Slf4j
@Validated
@Controller("base-VmIPsecTunnels")
...
public class BaseModuleController {
    ...
    public Object ajaxIndex(HttpServletRequest request) {
        Map<String,Object> list = vmipsectunnelsService.getListViewEntity(request,viewEntitys, VmIPsecTunnels.class);
    ...
    public Object editView(HttpServletRequest request,HttpServletResponse response, Model model) {
        ...
        VmIPsecTunnels result = (VmIPsecTunnels) vmipsectunnelsService.getObjectByRecord(httpRequest.get("record"),viewEntitys,VmIPsecTunnels.class);
        if(result != null) {
    ...
    public Object editViewSave(HttpServletRequest request, Model model) {
        try{
            ...
            vmipsectunnelsService.save(httpRequest,viewEntitys,VmIPsecTunnels.class);
    ...
    public Object delete(HttpServletRequest request, Model model) {
        try {
            Map<String, Object> httpRequest = Utils.getRequestQuery(request);
            vmipsectunnelsService.delete(httpRequest,viewEntitys);
    ...
    public Object active(HttpServletRequest request, Model model) {
        try{
            Map<String, Object> httpRequest = Utils.getRequestQuery(request);
            vmipsectunnelsService.active(httpRequest,viewEntitys);
    ...
    public Object inactive(HttpServletRequest request, Model model) {
        try{
            Map<String, Object> httpRequest = Utils.getRequestQuery(request);
            vmipsectunnelsService.inactive(httpRequest,viewEntitys);
    ...
    public Object popupView(HttpServletRequest request, Model model) {
        model.addAttribute("ENTITYURL", "VmIPsecTunnels/popupentity/ajax");
    ...
    public Object popupEntity(HttpServletRequest request, Model model) {
        Map<String,Object> list = vmipsectunnelsService.getListViewEntity(request,viewEntitys, VmZones.class);
