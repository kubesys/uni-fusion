package com.qnkj.clouds.modules.VmThreeLayerNetworks.entitys;
...
@Getter
@Setter
public class VmThreeLayerNetworks extends BaseRecordConfig {
	...
	public VmThreeLayerNetworks() {
		this.id = "";
	}

	public VmThreeLayerNetworks(Object dataObj) {
		this.id = "";
