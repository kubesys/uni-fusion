package com.qnkj.clouds.modules.VmRoutingResources.entitys;
...
@Getter
@Setter
public class VmRoutingResources extends BaseRecordConfig {
	...
	public VmRoutingResources() {
		this.id = "";
	}

	public VmRoutingResources(Object dataObj) {
		this.id = "";
