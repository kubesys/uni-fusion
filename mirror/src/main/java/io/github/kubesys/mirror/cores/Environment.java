...
public final class Environment {
	 ...
	 * Kubernetes的Token
	 */
	@Env(desc = "Kubernetes的Bearer Token", 
	 ...
	 * RabbitMQ的密码
	 */
	@Env(desc = "RabbitMQ队列数据超期删除时间，单位是毫秒", 
			defaultValue = "10000" ,
			example = "100")
