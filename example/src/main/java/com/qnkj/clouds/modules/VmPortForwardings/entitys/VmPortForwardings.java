package com.qnkj.clouds.modules.VmPortForwardings.entitys;
...
@Getter
@Setter
public class VmPortForwardings extends BaseRecordConfig {
	...
	public VmPortForwardings() {
		this.id = "";
	}

	public VmPortForwardings(Object dataObj) {
		this.id = "";
