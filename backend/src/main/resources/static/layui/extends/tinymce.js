...
layui.define(['jquery'],function (exports) {
    ...
    function initOptions(option,callback) {
        ...
        //advcode bdmap axupimgs formatpainter kityformula-editor
        // option.plugins = isset(option.plugins) ? option.plugins : 'print preview searchreplace autolink directionality visualblocks visualchars fullscreen image link media template code codesample table charmap hr pagebreak nonbreaking anchor insertdatetime advlist lists wordcount imagetools textpattern help emoticons autosave indent2em autoresize importword kityformula-editor';
        // option.toolbar = isset(option.toolbar) ? option.toolbar : 'code undo redo restoredraft | cut copy paste pastetext | forecolor backcolor bold italic underline strikethrough link anchor | alignleft aligncenter alignright alignjustify outdent indent | styleselect formatselect fontselect fontsizeselect | bullist numlist | blockquote subscript superscript removeformat | table image media charmap emoticons hr pagebreak insertdatetime print preview | fullscreen | indent2em lineheight importword';

        option.plugins = isset(option.plugins) ? option.plugins: 'print preview autolink directionality visualblocks visualchars fullscreen image link code codesample table charmap hr pagebreak nonbreaking anchor insertdatetime advlist lists wordcount imagetools textpattern help emoticons autosave indent2em autoresize importword kityformula-editor',
        option.toolbar = isset(option.toolbar) ? option.toolbar: 'code | undo redo restoredraft | cut copy paste pastetext | forecolor backcolor bold italic underline strikethrough link | blockquote subscript superscript | alignleft aligncenter alignright alignjustify outdent indent  | bullist numlist | fontselect fontsizeselect '
        ...
        option.menu = isset(option.menu) ? option.menu : {
            file: {title: '文件', items: 'code | newdocument | print preview fullscreen | wordcount'},
            edit: {title: '编辑', items: 'undo redo | cut copy paste pastetext selectall | searchreplace'},
            // view: {title: '查看', items: 'visualaid codesample code'},
            format: {
                title: '格式',
