layui.define(['jquery'], function (exports) {
    ...
    CityPicker.prototype = {
        ...
        getText: function () {
            var text = '';
            var iscityname = this.options.iscityname;
                ...
                .each(function () {
                    ...
                    if (item) {
                        text += ($(this).hasClass('province') ? '' : '/') + '<span class="select-item" data-count="' +
                            type + '" data-code="' + item.code + '">' + item.address + '</span><input type="hidden" id="' + type + '" name="' + type + '" value="' + (iscityname ? item.address : item.code) + '"  />';
                    }
                });
            return text;
        },
        ...
        feedVal: function () {
            ...
            if($.isFunction(this.options.selected)) this.options.selected()
        },
        ...
        hasVal: function(){
            if(this.$element.val() !== "") return true;
            return false;
        },
    ...
    CityPicker.DEFAULTS = {
        simple: false,
        responsive: false,
        iscityname: false,//设置返回值是区域代码还是区域名称
        selected: function(){},
