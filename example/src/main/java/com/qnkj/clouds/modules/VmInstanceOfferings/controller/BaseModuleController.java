...
@Slf4j
@Validated
@Controller("base-VmInstanceOfferings")
...
public class BaseModuleController {
    ...
    public Object ajaxIndex(HttpServletRequest request) {
        Map<String,Object> list = vminstanceofferingsService.getListViewEntity(request,viewEntitys, VmInstanceOfferings.class);
    ...
    public Object editView(HttpServletRequest request,HttpServletResponse response, Model model) {
        ...
        VmInstanceOfferings result = (VmInstanceOfferings) vminstanceofferingsService.getObjectByRecord(httpRequest.get("record"),viewEntitys,VmInstanceOfferings.class);
        if(result != null) {
    ...
    public Object editViewSave(HttpServletRequest request, Model model) {
        try{
            ...
            vminstanceofferingsService.save(httpRequest,viewEntitys,VmInstanceOfferings.class);
    ...
    public Object active(HttpServletRequest request, Model model) {
        try{
            Map<String, Object> httpRequest = Utils.getRequestQuery(request);
            vminstanceofferingsService.active(httpRequest,viewEntitys);
    ...
    public Object inactive(HttpServletRequest request, Model model) {
        try{
            Map<String, Object> httpRequest = Utils.getRequestQuery(request);
            vminstanceofferingsService.inactive(httpRequest,viewEntitys);
    ...
    public Object delete(HttpServletRequest request, Model model) {
        try {
            Map<String, Object> httpRequest = Utils.getRequestQuery(request);
            vminstanceofferingsService.delete(httpRequest,viewEntitys);
    ...
    public Object popupView(HttpServletRequest request, Model model) {
        model.addAttribute("ENTITYURL", "VmInstanceOfferings/popupentity/ajax");
