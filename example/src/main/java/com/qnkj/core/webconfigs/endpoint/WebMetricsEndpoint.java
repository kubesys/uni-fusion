 ...
 */
@WebEndPoint
public class WebMetricsEndpoint {

    private final MeterRegistry registry;

    public WebMetricsEndpoint(MeterRegistry registry) {
    ...
    @ReadOperation
    public WebMetricResponse metric(@Selector String requiredMetricName, @Nullable List<String> tag) {
        ...
        if (meters.isEmpty()) {
            ...
            return new WebMetricResponse(requiredMetricName, meterId.getDescription(), meterId.getBaseUnit(), this.asList(samples, Sample::new), this.asList(availableTags, AvailableTag::new));
        }
    }
    ...
    public static final class WebMetricResponse {
        ...
        WebMetricResponse(String name, String description, String baseUnit, List<Sample> measurements, List<AvailableTag> availableTags) {
            this.name = name;
