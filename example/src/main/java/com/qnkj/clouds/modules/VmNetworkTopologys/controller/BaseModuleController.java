...
import com.qnkj.clouds.modules.VmNetworkTopologys.entitys.VmNetworkTopologys;
...
@Slf4j
@Validated
@Controller("base-VmNetworkTopologys")
...
public class BaseModuleController {
    ...
    public Object ajaxIndex(HttpServletRequest request) {
        Map<String,Object> list = vmnetworktopologysService.getListViewEntity(request,viewEntitys, VmNetworkTopologys.class);
    ...
    public Object editView(HttpServletRequest request,HttpServletResponse response, Model model) {
        ...
        VmNetworkTopologys result = (VmNetworkTopologys) vmnetworktopologysService.getObjectByRecord(httpRequest.get("record"),viewEntitys,VmNetworkTopologys.class);
        if(result != null) {
    ...
    public Object editViewSave(HttpServletRequest request, Model model) {
        try{
            ...
            vmnetworktopologysService.save(httpRequest,viewEntitys,VmNetworkTopologys.class);
    ...
    public Object delete(HttpServletRequest request, Model model) {
        try {
            Map<String, Object> httpRequest = Utils.getRequestQuery(request);
            vmnetworktopologysService.delete(httpRequest,viewEntitys);
    ...
    public Object active(HttpServletRequest request, Model model) {
        try{
            Map<String, Object> httpRequest = Utils.getRequestQuery(request);
            vmnetworktopologysService.active(httpRequest,viewEntitys);
    ...
    public Object inactive(HttpServletRequest request, Model model) {
        try{
            Map<String, Object> httpRequest = Utils.getRequestQuery(request);
            vmnetworktopologysService.inactive(httpRequest,viewEntitys);
    ...
    public Object popupView(HttpServletRequest request, Model model) {
        model.addAttribute("ENTITYURL", "VmNetworkTopologys/popupentity/ajax");
    ...
    public Object popupEntity(HttpServletRequest request, Model model) {
        Map<String,Object> list = vmnetworktopologysService.getListViewEntity(request,viewEntitys, VmZones.class);
