...
import com.qnkj.clouds.modules.VmVirtualIPs.entitys.VmVirtualIPs;
...
public class BaseModuleController {
    ...
    public Object ajaxIndex(HttpServletRequest request) {
        Map<String,Object> list = vmvirtualipsService.getListViewEntity(request,viewEntitys, VmVirtualIPs.class);
    ...
    public Object editView(HttpServletRequest request,HttpServletResponse response, Model model) {
        ...
        VmVirtualIPs result = (VmVirtualIPs) vmvirtualipsService.getObjectByRecord(httpRequest.get("record"),viewEntitys,VmVirtualIPs.class);
        if(result != null) {
    ...
    public Object editViewSave(HttpServletRequest request, Model model) {
        try{
            ...
            vmvirtualipsService.save(httpRequest,viewEntitys,VmVirtualIPs.class);
    ...
    public Object delete(HttpServletRequest request, Model model) {
        try {
            Map<String, Object> httpRequest = Utils.getRequestQuery(request);
            vmvirtualipsService.delete(httpRequest,viewEntitys);
    ...
    public Object active(HttpServletRequest request, Model model) {
        try{
            Map<String, Object> httpRequest = Utils.getRequestQuery(request);
            vmvirtualipsService.active(httpRequest,viewEntitys);
    ...
    public Object inactive(HttpServletRequest request, Model model) {
        try{
            Map<String, Object> httpRequest = Utils.getRequestQuery(request);
            vmvirtualipsService.inactive(httpRequest,viewEntitys);
    ...
    public Object popupView(HttpServletRequest request, Model model) {
        model.addAttribute("ENTITYURL", "VmVirtualIPs/popupentity/ajax");
    ...
    public Object popupEntity(HttpServletRequest request, Model model) {
        Map<String,Object> list = vmvirtualipsService.getListViewEntity(request,viewEntitys, VmZones.class);
