package com.qnkj.clouds.modules.VmNetworkTopologys.entitys;
...
@Getter
@Setter
public class VmNetworkTopologys extends BaseRecordConfig {
	...
	public VmNetworkTopologys() {
		this.id = "";
	}

	public VmNetworkTopologys(Object dataObj) {
		this.id = "";
