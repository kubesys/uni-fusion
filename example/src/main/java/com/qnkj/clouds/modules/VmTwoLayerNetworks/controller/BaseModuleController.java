...
import com.qnkj.clouds.modules.VmTwoLayerNetworks.entitys.VmTwoLayerNetworks;
...
@Slf4j
@Validated
@Controller("base-VmTwoLayerNetworks")
...
public class BaseModuleController {
    ...
    public Object ajaxIndex(HttpServletRequest request) {
        Map<String,Object> list = vmtwolayernetworksService.getListViewEntity(request,viewEntitys, VmTwoLayerNetworks.class);
    ...
    public Object editView(HttpServletRequest request,HttpServletResponse response, Model model) {
        ...
        VmTwoLayerNetworks result = (VmTwoLayerNetworks) vmtwolayernetworksService.getObjectByRecord(httpRequest.get("record"),viewEntitys,VmTwoLayerNetworks.class);
        if(result != null) {
    ...
    public Object editViewSave(HttpServletRequest request, Model model) {
        try{
            ...
            vmtwolayernetworksService.save(httpRequest,viewEntitys,VmTwoLayerNetworks.class);
    ...
    public Object delete(HttpServletRequest request, Model model) {
        try {
            Map<String, Object> httpRequest = Utils.getRequestQuery(request);
            vmtwolayernetworksService.delete(httpRequest,viewEntitys);
    ...
    public Object active(HttpServletRequest request, Model model) {
        try{
            Map<String, Object> httpRequest = Utils.getRequestQuery(request);
            vmtwolayernetworksService.active(httpRequest,viewEntitys);
    ...
    public Object inactive(HttpServletRequest request, Model model) {
        try{
            Map<String, Object> httpRequest = Utils.getRequestQuery(request);
            vmtwolayernetworksService.inactive(httpRequest,viewEntitys);
    ...
    public Object popupView(HttpServletRequest request, Model model) {
        model.addAttribute("ENTITYURL", "VmTwoLayerNetworks/popupentity/ajax");
    ...
    public Object popupEntity(HttpServletRequest request, Model model) {
        Map<String,Object> list = vmtwolayernetworksService.getListViewEntity(request,viewEntitys, VmZones.class);
