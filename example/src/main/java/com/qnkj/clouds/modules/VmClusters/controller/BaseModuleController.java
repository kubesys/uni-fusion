...
import com.qnkj.clouds.modules.VmClusters.entitys.VmClusters;
...
public class BaseModuleController {
    ...
    public Object ajaxIndex(HttpServletRequest request) {
        Map<String,Object> list = vmclustersService.getListViewEntity(request,viewEntitys, VmClusters.class);
    ...
    public Object editView(HttpServletRequest request,HttpServletResponse response, Model model) {
        ...
        VmClusters result = (VmClusters) vmclustersService.getObjectByRecord(httpRequest.get("record"),viewEntitys,VmClusters.class);
        if(result != null) {
    ...
    public Object editViewSave(HttpServletRequest request, Model model) {
        try{
            ...
            vmclustersService.save(httpRequest,viewEntitys,VmClusters.class);
    ...
    public Object delete(HttpServletRequest request, Model model) {
        try {
            Map<String, Object> httpRequest = Utils.getRequestQuery(request);
            vmclustersService.delete(httpRequest,viewEntitys);
    ...
    public Object active(HttpServletRequest request, Model model) {
        try{
            Map<String, Object> httpRequest = Utils.getRequestQuery(request);
            vmclustersService.active(httpRequest,viewEntitys);
    ...
    public Object inactive(HttpServletRequest request, Model model) {
        try{
            Map<String, Object> httpRequest = Utils.getRequestQuery(request);
            vmclustersService.inactive(httpRequest,viewEntitys);
    ...
    public Object popupView(HttpServletRequest request, Model model) {
        model.addAttribute("ENTITYURL", "VmClusters/popupentity/ajax");
