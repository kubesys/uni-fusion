...
public class MoneyUtils {
    ...
    public static double getMoney(double v) {
    ...
    public static String longToMoney(long money) {
        ...
        return String.format("%.2f", doubleMoney);
    }

    /**
     *  分为单位的长整型，转元为单位的字符串(去掉.00)
     */
    public static String longToTrimMoney(long money) {
        double doubleMoney = money / 100.0;
        return String.format("%.2f", doubleMoney).replace(".00","");
    }
