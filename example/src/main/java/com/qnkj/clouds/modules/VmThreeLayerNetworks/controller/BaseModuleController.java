...
import com.qnkj.clouds.modules.VmThreeLayerNetworks.entitys.VmThreeLayerNetworks;
...
@Slf4j
@Validated
@Controller("base-VmThreeLayerNetworks")
...
public class BaseModuleController {
    ...
    public Object ajaxIndex(HttpServletRequest request) {
        Map<String,Object> list = vmthreelayernetworksService.getListViewEntity(request,viewEntitys, VmThreeLayerNetworks.class);
    ...
    public Object editView(HttpServletRequest request,HttpServletResponse response, Model model) {
        ...
        VmThreeLayerNetworks result = (VmThreeLayerNetworks) vmthreelayernetworksService.getObjectByRecord(httpRequest.get("record"),viewEntitys,VmThreeLayerNetworks.class);
        if(result != null) {
    ...
    public Object editViewSave(HttpServletRequest request, Model model) {
        try{
            ...
            vmthreelayernetworksService.save(httpRequest,viewEntitys,VmThreeLayerNetworks.class);
    ...
    public Object delete(HttpServletRequest request, Model model) {
        try {
            Map<String, Object> httpRequest = Utils.getRequestQuery(request);
            vmthreelayernetworksService.delete(httpRequest,viewEntitys);
    ...
    public Object active(HttpServletRequest request, Model model) {
        try{
            Map<String, Object> httpRequest = Utils.getRequestQuery(request);
            vmthreelayernetworksService.active(httpRequest,viewEntitys);
    ...
    public Object inactive(HttpServletRequest request, Model model) {
        try{
            Map<String, Object> httpRequest = Utils.getRequestQuery(request);
            vmthreelayernetworksService.inactive(httpRequest,viewEntitys);
    ...
    public Object popupView(HttpServletRequest request, Model model) {
        model.addAttribute("ENTITYURL", "VmThreeLayerNetworks/popupentity/ajax");
    ...
    public Object popupEntity(HttpServletRequest request, Model model) {
        Map<String,Object> list = vmthreelayernetworksService.getListViewEntity(request,viewEntitys, VmZones.class);
