...
import com.qnkj.clouds.modules.VmLoadBalances.entitys.VmLoadBalances;
...
@Slf4j
@Validated
@Controller("base-VmLoadBalances")
...
public class BaseModuleController {
    ...
    public Object ajaxIndex(HttpServletRequest request) {
        Map<String,Object> list = vmloadbalancesService.getListViewEntity(request,viewEntitys, VmLoadBalances.class);
    ...
    public Object editView(HttpServletRequest request,HttpServletResponse response, Model model) {
        ...
        VmLoadBalances result = (VmLoadBalances) vmloadbalancesService.getObjectByRecord(httpRequest.get("record"),viewEntitys,VmLoadBalances.class);
        if(result != null) {
    ...
    public Object editViewSave(HttpServletRequest request, Model model) {
        try{
            ...
            vmloadbalancesService.save(httpRequest,viewEntitys,VmLoadBalances.class);
    ...
    public Object delete(HttpServletRequest request, Model model) {
        try {
            Map<String, Object> httpRequest = Utils.getRequestQuery(request);
            vmloadbalancesService.delete(httpRequest,viewEntitys);
    ...
    public Object active(HttpServletRequest request, Model model) {
        try{
            Map<String, Object> httpRequest = Utils.getRequestQuery(request);
            vmloadbalancesService.active(httpRequest,viewEntitys);
    ...
    public Object inactive(HttpServletRequest request, Model model) {
        try{
            Map<String, Object> httpRequest = Utils.getRequestQuery(request);
            vmloadbalancesService.inactive(httpRequest,viewEntitys);
    ...
    public Object popupView(HttpServletRequest request, Model model) {
        model.addAttribute("ENTITYURL", "VmLoadBalances/popupentity/ajax");
    ...
    public Object popupEntity(HttpServletRequest request, Model model) {
        Map<String,Object> list = vmloadbalancesService.getListViewEntity(request,viewEntitys, VmZones.class);
