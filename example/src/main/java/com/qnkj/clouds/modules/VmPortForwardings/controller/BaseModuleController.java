...
import com.qnkj.clouds.modules.VmPortForwardings.entitys.VmPortForwardings;
...
@Slf4j
@Validated
@Controller("base-VmPortForwardings")
...
public class BaseModuleController {
    ...
    public Object ajaxIndex(HttpServletRequest request) {
        Map<String,Object> list = vmportforwardingsService.getListViewEntity(request,viewEntitys, VmPortForwardings.class);
    ...
    public Object editView(HttpServletRequest request,HttpServletResponse response, Model model) {
        ...
        VmPortForwardings result = (VmPortForwardings) vmportforwardingsService.getObjectByRecord(httpRequest.get("record"),viewEntitys,VmPortForwardings.class);
        if(result != null) {
    ...
    public Object editViewSave(HttpServletRequest request, Model model) {
        try{
            ...
            vmportforwardingsService.save(httpRequest,viewEntitys,VmPortForwardings.class);
    ...
    public Object delete(HttpServletRequest request, Model model) {
        try {
            Map<String, Object> httpRequest = Utils.getRequestQuery(request);
            vmportforwardingsService.delete(httpRequest,viewEntitys);
    ...
    public Object active(HttpServletRequest request, Model model) {
        try{
            Map<String, Object> httpRequest = Utils.getRequestQuery(request);
            vmportforwardingsService.active(httpRequest,viewEntitys);
    ...
    public Object inactive(HttpServletRequest request, Model model) {
        try{
            Map<String, Object> httpRequest = Utils.getRequestQuery(request);
            vmportforwardingsService.inactive(httpRequest,viewEntitys);
    ...
    public Object popupView(HttpServletRequest request, Model model) {
        model.addAttribute("ENTITYURL", "VmPortForwardings/popupentity/ajax");
    ...
    public Object popupEntity(HttpServletRequest request, Model model) {
        Map<String,Object> list = vmportforwardingsService.getListViewEntity(request,viewEntitys, VmZones.class);
