package com.qnkj.clouds.modules.VmSecurityGroups.entitys;
...
@Getter
@Setter
public class VmSecurityGroups extends BaseRecordConfig {
	...
	public VmSecurityGroups() {
		this.id = "";
	}

	public VmSecurityGroups(Object dataObj) {
		this.id = "";
