...
import com.qnkj.clouds.modules.VmAffinityGroups.entitys.VmAffinityGroups;
...
@Slf4j
@Validated
@Controller("base-VmAffinityGroups")
...
public class BaseModuleController {
    ...
    public Object ajaxIndex(HttpServletRequest request) {
        Map<String,Object> list = vmaffinitygroupsService.getListViewEntity(request,viewEntitys, VmAffinityGroups.class);
    ...
    public Object editView(HttpServletRequest request,HttpServletResponse response, Model model) {
        ...
        VmAffinityGroups result = (VmAffinityGroups) vmaffinitygroupsService.getObjectByRecord(httpRequest.get("record"),viewEntitys,VmAffinityGroups.class);
        if(result != null) {
    ...
    public Object editViewSave(HttpServletRequest request, Model model) {
        try{
            ...
            vmaffinitygroupsService.save(httpRequest,viewEntitys,VmAffinityGroups.class);
    ...
    public Object delete(HttpServletRequest request, Model model) {
        try {
            Map<String, Object> httpRequest = Utils.getRequestQuery(request);
            vmaffinitygroupsService.delete(httpRequest,viewEntitys);
    ...
    public Object active(HttpServletRequest request, Model model) {
        try{
            Map<String, Object> httpRequest = Utils.getRequestQuery(request);
            vmaffinitygroupsService.active(httpRequest,viewEntitys);
    ...
    public Object inactive(HttpServletRequest request, Model model) {
        try{
            Map<String, Object> httpRequest = Utils.getRequestQuery(request);
            vmaffinitygroupsService.inactive(httpRequest,viewEntitys);
    ...
    public Object popupView(HttpServletRequest request, Model model) {
        model.addAttribute("ENTITYURL", "VmAffinityGroups/popupentity/ajax");
    ...
    public Object popupEntity(HttpServletRequest request, Model model) {
        Map<String,Object> list = vmaffinitygroupsService.getListViewEntity(request,viewEntitys, VmZones.class);
