...
import com.qnkj.clouds.modules.VmAutoscalingGroups.entitys.VmAutoscalingGroups;
...
@Slf4j
@Validated
@Controller("base-VmAutoscalingGroups")
...
public class BaseModuleController {
    ...
    public Object ajaxIndex(HttpServletRequest request) {
        Map<String,Object> list = vmautoscalinggroupsService.getListViewEntity(request,viewEntitys, VmAutoscalingGroups.class);
    ...
    public Object editView(HttpServletRequest request,HttpServletResponse response, Model model) {
        ...
        VmAutoscalingGroups result = (VmAutoscalingGroups) vmautoscalinggroupsService.getObjectByRecord(httpRequest.get("record"),viewEntitys,VmAutoscalingGroups.class);
        if(result != null) {
    ...
    public Object editViewSave(HttpServletRequest request, Model model) {
        try{
            ...
            vmautoscalinggroupsService.save(httpRequest,viewEntitys,VmAutoscalingGroups.class);
    ...
    public Object delete(HttpServletRequest request, Model model) {
        try {
            Map<String, Object> httpRequest = Utils.getRequestQuery(request);
            vmautoscalinggroupsService.delete(httpRequest,viewEntitys);
    ...
    public Object active(HttpServletRequest request, Model model) {
        try{
            Map<String, Object> httpRequest = Utils.getRequestQuery(request);
            vmautoscalinggroupsService.active(httpRequest,viewEntitys);
    ...
    public Object inactive(HttpServletRequest request, Model model) {
        try{
            Map<String, Object> httpRequest = Utils.getRequestQuery(request);
            vmautoscalinggroupsService.inactive(httpRequest,viewEntitys);
    ...
    public Object popupView(HttpServletRequest request, Model model) {
        model.addAttribute("ENTITYURL", "VmAutoscalingGroups/popupentity/ajax");
    ...
    public Object popupEntity(HttpServletRequest request, Model model) {
        Map<String,Object> list = vmautoscalinggroupsService.getListViewEntity(request,viewEntitys, VmZones.class);
