...
import com.qnkj.clouds.modules.VmRoutingResources.entitys.VmRoutingResources;
...
@Slf4j
@Validated
@Controller("base-VmRoutingResources")
...
public class BaseModuleController {
    ...
    public Object ajaxIndex(HttpServletRequest request) {
        Map<String,Object> list = vmroutingresourcesService.getListViewEntity(request,viewEntitys, VmRoutingResources.class);
    ...
    public Object editView(HttpServletRequest request,HttpServletResponse response, Model model) {
        ...
        VmRoutingResources result = (VmRoutingResources) vmroutingresourcesService.getObjectByRecord(httpRequest.get("record"),viewEntitys,VmRoutingResources.class);
        if(result != null) {
    ...
    public Object editViewSave(HttpServletRequest request, Model model) {
        try{
            ...
            vmroutingresourcesService.save(httpRequest,viewEntitys,VmRoutingResources.class);
    ...
    public Object delete(HttpServletRequest request, Model model) {
        try {
            Map<String, Object> httpRequest = Utils.getRequestQuery(request);
            vmroutingresourcesService.delete(httpRequest,viewEntitys);
    ...
    public Object active(HttpServletRequest request, Model model) {
        try{
            Map<String, Object> httpRequest = Utils.getRequestQuery(request);
            vmroutingresourcesService.active(httpRequest,viewEntitys);
    ...
    public Object inactive(HttpServletRequest request, Model model) {
        try{
            Map<String, Object> httpRequest = Utils.getRequestQuery(request);
            vmroutingresourcesService.inactive(httpRequest,viewEntitys);
    ...
    public Object popupView(HttpServletRequest request, Model model) {
        model.addAttribute("ENTITYURL", "VmRoutingResources/popupentity/ajax");
    ...
    public Object popupEntity(HttpServletRequest request, Model model) {
        Map<String,Object> list = vmroutingresourcesService.getListViewEntity(request,viewEntitys, VmZones.class);
